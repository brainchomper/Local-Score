        ...
        <Router>
          <div className="mt-5">
            <SideNav logo="./images/logo.png" isOpenWithButton={isOpenWithButtonA} breakWidth={1300} style={sideStyle} hidden href="/">
						...
						<div className="col">
						<Avatar tag="img" src="https://lh4.googleusercontent.com/-7_7SM6AwTII/AAAAAAAAAAI/AAAAAAAALH0/B7gqmejvbn0/s96-c/photo.jpg" className="rounded-circle z-depth-1-half img-fluid m-3 text-center" alt="User Image"/>
						</div>
						</div>

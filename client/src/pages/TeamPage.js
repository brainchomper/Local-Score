			...
			<section className="pt-4">
				...
				<Row className="text-center">
					...
					<Col lg="3" md="6" className="mb-lg-0 mb-5">
						...
						<img src="./images/team/QRJohn.png" alt="John" className="img-fluid px-4" href="https://" target="blank" />
					...
					<Col lg="3" md="6" className="mb-lg-0 mb-5">
						...
						<p className="grey-text hoverable px-2">Full MERN Developer specializing in Front End Developement.<br/><br/>
					...
					<Col lg="3" md="6" className="mb-lg-0 mb-5">
						...
						<p className="grey-text hoverable ">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim est fugiat nulla id eu laborum.
						<img src="./images/team/QRJoe.png" alt="Joe" className="img-fluid px-4" href="https://" target="blank" />
					...
					<Col lg="3" md="6" className="mb-lg-0 mb-5">
						...
						<p className="text-uppercase blue-text">Full Stack Web Developer<br/> Something Here</p>
						<p className="grey-text hoverable px-2">Full MERN Developer<br/>
						<img src="./images/team/QRAlex.png" alt="Kevin Smith PNG" className="img-fluid px-4" href="https://kvnsmith.com" target="blank" />
						<ul className="list-unstyled mb-0">
							<a className="p-2 fa-lg" target="blank" href="https://github.com/brainchomper">
								<Fa icon="github" className="blue-text" />
							</a>
